...
export function SpeedDialNav() {
  ...
  return (
    <>
      ...
      <button
        className="relative h-12 aspect-square p-0 rounded-full bg-blue-500 perspective-dramatic"
        onClick={() => setOpen(!open)}
      >
        <div
          className={`flex justify-center items-center aspect-square rounded-full p-2 border-3 border-black duration-500 ${
            open && "-rotate-z-135"
          }`}
        >
